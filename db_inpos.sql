...
--
-- Table structure for table `pos_mamber`
--

CREATE TABLE `pos_mamber` (
...
--
-- Table structure for table `pos_suppller`
--

CREATE TABLE `pos_suppller` (
  `id_supplier` char(7) NOT NULL,
...
('181530008', 'I''anatul Birriyah', 'ianatulbirriyah13@gmail.com', '0192023a7bbd73250516f069df18b500', 'administrator', 1);
...
--
-- Indexes for table `pos_mamber`
--
ALTER TABLE `pos_mamber`
...
ALTER TABLE `pos_penjualan`
  ADD PRIMARY KEY (`no_trans`,`id_mamber`,`id_user`);
...
--
-- Indexes for table `pos_suppller`
--
ALTER TABLE `pos_suppller`
